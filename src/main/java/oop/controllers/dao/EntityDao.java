...
public class EntityDao extends Dao<Entity> {
     ...
     */
    public void insert(List<? extends Entity> values) throws RuntimeException {
    ...
    private Entity fromBaseDocument(BaseDocument baseDocument) {
        ...
        if (COUNTRY_CLASS_NAME.equals(className)) {
            ...
            result.setContent((String) propertiesMap.get("Content"));
            result.setLabel((String) propertiesMap.get("Label"));
            String continentName = (String) propertiesMap.get("Continent");
            if (continentName != null)
                result.setContinent(CountryEntity.Continent.valueOf(continentName));
            return result;
        }
        ...
        if (LOCATION_CLASS_NAME.equals(className)) {
            ...
            result.setContent((String) propertiesMap.get("Content"));
            result.setLabel((String) propertiesMap.get("Label"));
            result.setLatitude(Double.parseDouble((String) propertiesMap.get("Latitude")));
            result.setLongitude(Double.parseDouble((String) propertiesMap.get("Longitude")));
            return result;
        }
    ...
    private BaseDocument fromEntity(Entity entity) {
        ...
        for (Method method : entity.getClass().getMethods()) {
            ...
            try {
                ...
                if (property != null)
                    propertiesMap.put(propertyName, property.toString());
